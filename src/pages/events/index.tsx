    ...
    return (
        <>
            ...
            <VStack className="w-full">
                ...
                <VStack gap={16} className="max-w-screen-xl" style={{ marginBottom: 64 }}>
                    <HStack>
                    ...
                    <VStack className="max-w-screen-xl" style={{ alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                        ...
                        <p>
                            ...
                            als auch Geist wiederherzustellen. Tauche ein in den Fluss von Bewegung und Atem, während du die Belastungen des
                            Alltags hinter dir lässt. Mit dem sanften Abschluss der Yogastunde erwartet dich eine 15-minütige
                            Meditations-Session, die von Eva persönlich geleitet wird. Diese Meditation öffnet die Pforten zur inneren
                            Gelassenheit und ermöglicht es dir, deine Sorgen beiseitezuschieben, eine tiefe Verbindung zu deinem Inneren
                            aufzubauen und eine Fülle positiver Energie zu erzeugen, die dich noch lange nach dem Event begleiten wird.
                        </p>
                        ...
                        <p>
                            ...
                            Brunch-Konzept dreht sich um Granola, eine vielseitige und nahrhafte Zutat, geliefert von Grainology - einem
                            innovativen Frankfurter Start-up, bekannt für seine einzigartigen Granola-Geschmacksrichtungen. Entdecke die
                            Geheimnisse des Kochs, um Gerichte zu zaubern, die nicht nur exquisit schmecken, sondern auch kunstvoll für
                            Instagram geeignet sind. Lass deine Kreativität fließen, während du deine Kreationen anrichtest und deine
                            Gerichte in Meisterwerke verwandelst, die genauso erfreulich anzusehen sind wie sie zu genießen.
                        </p>
                        ...
                        <HStack className="w-full" style={{ alignItems: 'center' }}>
                            <Link href={stripePaymentUrl} className="no-underline p-3 " style={{ width: '100%', maxWidth: 256 }}>
                                <PEButton title=" Jetzt Buchen" onClick={(): void => undefined} />
                            </Link>
                        </HStack>
                    </VStack>
