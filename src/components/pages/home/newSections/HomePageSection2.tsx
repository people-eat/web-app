        ...
        <div className={styles.section}>
            ...
            <div className={styles.newSectionBody}>
                <div className={styles.newSectionEntry}>
                    <Image unoptimized src="/home/2/köche.png" alt="" width={380} height={240} className={styles.newSectionEntryImage} />
                ...
                <div className={styles.newSectionEntry}>
                    <Image unoptimized src="/home/2/chat.png" alt="" width={380} height={240} className={styles.newSectionEntryImage} />
