...
export interface ChefProfilePageBookingsChatMessagesProps {
    cookId: string;
    bookingRequestId: string;
}

export default function ChefProfilePageBookingsChatMessages({
    cookId,
    bookingRequestId,
}: ChefProfilePageBookingsChatMessagesProps): ReactElement {
