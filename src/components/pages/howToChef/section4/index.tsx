    ...
    return (
        <VStack className="w-full max-w-screen-xl lg:px-8 box-border">
            <VStack className="w-full relative gap-8 lg:mb-4 mt-[100px]">
                <div className="flex w-full lg:justify-center mt-[120px]">
                ...
                <VStack className="w-full relative h-[400px]">
                    <Image
                        className="absolute z-20 w-[calc(100%-530px)] top-[50%]"
                    ...
                    <HStack className="w-full h-[500px]" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <PEButton onClick={(): void => undefined} title={signUpBtn} className="max-w-[250px] mt-10" />
            </VStack>
        </VStack>
    );
}
