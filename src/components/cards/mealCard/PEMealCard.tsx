...
export default function PEMealCard({ onClick, title, description, imageUrl }: PEMealCardProps): ReactElement {
    return (
        <div
            onClick={onClick}
            className="flex min-w-[380px] w-full max-w-[410px] max-h-[144px] gap-3 flex-row p-3 box-border rounded-3 shadow-primary cursor-pointer active:shadow-orange hover:shadow-active"
        >
