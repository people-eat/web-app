...
export default function PEReviewCardChef({
    ...
    return (
        <div
            className="flex md:max-w-[340px] md:w-full w-[380px] gap-4 flex-col p-8 box-border rounded-3 shadow-primary cursor-pointer hover:shadow-active duration-200 ease-in"
            onClick={onClick}
        >
