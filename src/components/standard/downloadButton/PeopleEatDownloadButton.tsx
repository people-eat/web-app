...
import { type PeopleEatDownloadButtonProps } from './PeopleEatDownloadButtonProps';

export default function PeopleEatDownloadButton({ disabled, title, downloadSize, onClick }: PeopleEatDownloadButtonProps): ReactElement {
