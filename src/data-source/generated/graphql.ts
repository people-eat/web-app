...
export type Gender = 'DIVERSE' | 'FEMALE' | 'MALE' | 'UNKNOWN';
...
export type CreateOneByEmailAddressMutationVariables = Exact<{
    request: CreateOneUserByEmailAddressRequest;
}>;

export type CreateOneByEmailAddressMutation = { __typename?: 'Mutation'; users: { __typename?: 'UserMutation'; success: boolean } };
...
export const CreateOneByEmailAddressDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
} as unknown as DocumentNode<CreateOneByEmailAddressMutation, CreateOneByEmailAddressMutationVariables>;
